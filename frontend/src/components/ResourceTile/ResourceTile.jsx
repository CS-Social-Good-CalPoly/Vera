        ...
        <div className="resource-tile-expanded-text-hours">
            ...
            <div className="resource-tile-expanded-text-hours-item-container">
                {props.hours.map((item, index) => (
                    <p key={index} className="resource-tile-expanded-text-hours-item">
                        {item}
                    </p>
                ))}
            </div>
...
function WhatToExpect(props) {
    return (
        <Col
            xs={12}
            md={7}
            className="resource-tile-expanded-text-group-toExpect"
        >
            <p className="resource-tile-expanded-to-expect">
                <strong>What To Expect:</strong>
            </p>
            <ul className="resource-tile-expanded-to-expect">
                {props.toExpect.map((item, i) => (
                    <li
                        className="resource-tile-expanded-to-expect-item"
                        key={
